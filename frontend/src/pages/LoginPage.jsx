    ...
    <div className="min-h-screen bg-[#f8f9fa] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Prijavite se kako biste nastavili razmenu znanja
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow-xl sm:rounded-xl sm:px-10 border border-gray-100">
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#7e52a0] focus:border-[#7e52a0] sm:text-sm transition"
                />
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Nemate nalog?{" "}
              <Link to="/register" className="font-bold text-[#7e52a0] hover:text-[#29274c] transition-colors">
